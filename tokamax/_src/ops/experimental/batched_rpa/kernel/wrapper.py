...
def ragged_paged_attention(
  ...
  """
    ...
    orig_kv_shape = kv_cache.shape
    if kv_cache.ndim == 4:
        total_pages, ps, num_kv_x2, hd = orig_kv_shape
    ...
    if len(orig_kv_shape) == 4:
        kv_cache = kv_cache.reshape(orig_kv_shape)
    if not return_lse:
