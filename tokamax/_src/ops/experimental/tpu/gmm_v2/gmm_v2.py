  ...
  def _matmul(is_first_k_step: bool, is_last_k_step: bool):
    ...
    if cfgs.lhs_cfgs.quant_dtype is None:
      ...
      for start_n in range(0, rhs_tile_n, mxu_size):
        ...
        for start_k in range(0, cfgs.tiles.tile_k, rhs_step_k):  # pyrefly: ignore[bad-argument-type]
          end_k = min(cfgs.tiles.tile_k, start_k + rhs_step_k)  # pyrefly: ignore[unsupported-operation]
          ...
          if (
            ...
            rhs_scale_replicated = tiled_rhs_ref.get_scale(
                replicate_size=cfgs.tiles.tile_m
