...
from tokamax._src.ops.experimental.tpu.gmm_v2.gmm_v2 import (
    Dimensions,
    GmmConfigs,
    InputConfigs,
    MetadataRef,
...
def make_tgmm_configs(
  ...
  if isinstance(tile_info, TileSizes):
    ...
    tiles = tile_info(dims, lhs_cfgs, rhs_cfgs, vmem_limit_bytes, out_dtype, acc_dtype)  # pyrefly: ignore[bad-argument-type]
