...
# ==============================================================================
"""Tests for Pallas/Mosaic Ragged Gather V2 raw kernel on TPU."""
...
class PallasTpuRaggedGatherV2KernelTest(parameterized.TestCase):
  ...
  def test_sc_gather_kernel(self, in_out_size, hidden_size, start_end, dtype):
    ...
    actual = pallas_mosaic_v2_tpu_kernel.ragged_gather_pallas(
