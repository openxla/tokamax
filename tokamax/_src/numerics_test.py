...
class NumericsTest(parameterized.TestCase):
  ...
  def test_random_initialize_consistency(self):
    ...
    kwargs_expected = {
        'bfloat16': np.float64(6.456298828125),
        'bool': np.float64(27.0),
        'float16': np.float64(-1.67376708984375),
        'float32': np.float64(-6.23777203541249),
        'int32': np.float64(77.0),
        'int4': np.float64(-18.0),
        'int64': np.float64(58.0),
        'int8': np.float64(180.0),
        'uint32': np.float64(3275.0),
        'uint4': np.float64(377.0),
        'uint64': np.float64(3019.0),
        'uint8': np.float64(3319.0),
    }
